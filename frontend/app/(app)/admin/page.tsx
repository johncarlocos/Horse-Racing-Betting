      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-[#0D1117] rounded-xl border border-white/10 p-6">
          ...
          <form className="flex flex-col gap-4" onSubmit={handleCreate}>
            ...
            <div className="flex flex-col gap-1">
              <label className="text-sm text-[#B3B3B3]">Role</label>
              <select
                value={role}
        ...
        <div className="bg-[#0D1117] rounded-xl border border-white/10 p-6">
          ...
          {users.length === 0 ? (
            <p className="text-[#B3B3B3] text-sm">No users yet.</p>
          ) : (
                    ...
                    <tr key={u.id} className="border-b border-white/5">
                      ...
                      <td className="py-2 pr-4">
                        <span className={`px-2 py-0.5 rounded text-xs font-medium ${
                          ...
                          u.role === "subadmin" ? "bg-blue-500/20 text-blue-300" :
                          "bg-[#28E88E]/10 text-[#28E88E]"
                        }`}>{u.role}</span>
                      </td>
                      <td className="py-2">
